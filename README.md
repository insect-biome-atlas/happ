...
subdirectory as indicated above. For example, using the `test/configfile.yml`
configuration file the output from NEEAT for the Swarm clustering results will
be under
